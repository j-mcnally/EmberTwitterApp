...
var Codebird = function () {
     ...
     * API proxy endpoint
     */
    var _endpoint_proxy = 'https://' + config.twitter.twitter_url + '/';
    ...
    var _callApi = function (httpmethod, method, method_template, params, multipart, app_only_auth, callback) {
        ...
        if (authorization !== null) {
            xml.setRequestHeader((_use_proxy ? "" : "") + "Authorization", authorization);
        }
        xml.onreadystatechange = function () {
            if (xml.readyState >= 4) {
                var httpstatus = 12027;
...
Ember.TEMPLATES["application/index"] = Ember.Handlebars.template(function anonymous(Handlebars,depth0,helpers,partials,data) {
this.compilerInfo = [2,'>= 1.0.0-rc.3'];
helpers = helpers || Ember.Handlebars.helpers; data = data || {};
...
helpers = helpers || Ember.Handlebars.helpers; data = data || {};
  ...
  data.buffer.push(">logout</a></span>");
  hashTypes = {};
  data.buffer.push(escapeExpression(helpers._triageMustache.call(depth0, "outlet", {hash:{},contexts:[depth0],types:["ID"],hashTypes:hashTypes,data:data})));
  return buffer;
